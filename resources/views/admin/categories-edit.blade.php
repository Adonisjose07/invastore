                        ...
                        <div class="bg-white px-4 py-5 sm:p-6">
                            <div class="grid grid-cols-1 gap-6">
                                <div class="col-span-1">
                                    <label for="category-name" class="block text-sm font-bold font-medium text-gray-700">Category Name</label>
                                    <input 
                                        type="text" 
                                        name="category-name" 
                                        id="category-name" 
                                    ...
                                    >
                                    <p class="mt-2">
                                        <i class="text-sm font-italic text-gray-700">Slug: </i> <i class="text-gray-500">{{$category->slug}}</i>
                                    </p>
                                </div>
                                ...
                                <div class="col-span-1">
                                    ...
                                    <div class="mt-1 flex items-center">
                                        <span class="inline-block h-12 w-12 overflow-hidden rounded-full bg-gray-100">
                                            ...
                                            @if($category->banner != null)
                                                <img id="imgMainPhoto" class="" src="{{asset('storage/'.$category->banner)}}">
                                            @else
                                ...
                                <div class="col-span-1">
                                    <label for="category-description" class="block text-sm font-medium text-gray-700 font-bold">Description</label>
                                    <div class="mt-1">
                                        <textarea id="category-description" name="category-description" rows="3" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" placeholder="Check this amazing collection of cake toppers">{{$category->description}}</textarea>
                                    </div>
